...
export async function generateObject<T>({
  ...
  const geminiSchema = {
    ...
    properties: Object.entries(schema.properties).reduce<Record<string, GeminiSchemaProperty>>((acc, [key, value]: [string, any]) => {
      acc[key] = {
        ...
        ...(value.type === 'array' && {
          items: {
            ...
            ...(value.items.properties && {
              properties: Object.entries(value.items.properties).reduce<Record<string, GeminiSchemaProperty>>((props, [pKey, pValue]: [string, any]) => {
                props[pKey] = {
        ...
        ...(value.type === 'object' && value.properties && {
          properties: Object.entries(value.properties).reduce<Record<string, GeminiSchemaProperty>>((props, [pKey, pValue]: [string, any]) => {
            props[pKey] = {
